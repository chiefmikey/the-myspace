exports.dummyData = [
  {
    ...
    friends: [
      [1, 1],
      [0, 2],
      ['clifford', '/img/wbyte.png', 3],
      ['pluto', '/img/wbyte.png', 4],
      ['marley', '/img/wbyte.png', 5],
      ['beethoven', '/img/wbyte.png', 6],
      ['lassie', '/img/wbyte.png', 7],
      ['airbud', '/img/wbyte.png', 8],
      ['airbud 2', '/img/wbyte.png', 9],
      ['airbud returns', '/img/wbyte.png', 10],
      ['airbud off the bench', '/img/wbyte.png', 11],
      ['airbud slam dunk', '/img/wbyte.png', 12],
    ],
    friendsTop: [
      [1, 1],
      [0, 2],
  ...
  },
  {
    ...
    blurbsWhoIdLikeToMeet: 'charlie from from charlie brown',
    friends: [
      [0, 1],
      [0, 2],
      ['clifford', '/img/wbyte.png', 3],
